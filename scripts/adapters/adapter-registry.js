"use strict";
const adapters = ["generic-feed","generic-json","generic-csv","rakuten","ebay","walmart","lowes","home-depot","target","amazon","best-buy","newegg","b-and-h","tractor-supply"].map(name=>require(`./${name}-adapter.js`));
